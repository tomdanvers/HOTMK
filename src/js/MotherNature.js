...
import {Deer, Rabbit, Fox, Wolf} from './Animal';
...
MotherNature.prototype.spawn = function(animalArchetype) {
    ...
    let animal = new animalArchetype.c(this.world, animalArchetype, World.WIDTH * Tile.WIDTH * Math.random(), World.HEIGHT * Tile.HEIGHT * Math.random());
...
AnimalArchetype.WOLF = new AnimalArchetype('wolf', 20, 10, 1, Wolf, .9, 120, 10, true, 80);
